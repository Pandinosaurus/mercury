...
By default, the expander has an outer border, a box background, and a shaded clickable header.
You can turn off the outer border and header background independently.
...
The returned expander output supports `.clear()`.
